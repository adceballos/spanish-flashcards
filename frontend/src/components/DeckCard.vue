...
<template>
  ...
  <RouterLink :to="deckSlug">
    <div ref="container" @mouseenter="hasInteracted = true" class="flex flex-col pl-4 pt-4 pb-8 items-start bg-gray-500 rounded-2xl shadow-xl gap-y-2 hover:cursor-pointer" :style="{
